# Visuel sjekk - om alt ble lastet ned riktig
Get-ADRootDSE
Get-ADForest
Get-ADDomain
...
Write-Output "`n`nScript for setup og konfigurering av domenekontroller`n"
Write-Output "NB! Script ma kjores på server som blir DC!`n"
do{
    Write-Output "`n#####################"
    $kommando = Read-Host "(1)Lag OU`n(2)Ny klient/server`n(0)Quit`nValg: "
